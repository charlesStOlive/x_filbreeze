                ...
                >
                    @foreach ($containers as $uuid => $item)
                        ...
                        <li
                            ...
                            class="fi-fo-repeater-item {{ $itemColor }} divide-y divide-gray-100 rounded-xl shadow-sm ring-1 ring-gray-950/5 dark:divide-white/10 dark:bg-white/5 dark:ring-white/10"
