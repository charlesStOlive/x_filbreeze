...
namespace App\Filament\Overrides\Concerns;
...
trait ResolvesActionAttributes
{
    ...
    /**
     * Resolve color - Fixed to accept both string and array returns
     * Compatible with Filament Color::Red arrays and string color names
     */
