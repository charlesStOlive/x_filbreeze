...
class Action extends BaseAction implements Groupable, HasRecord, HasTree
{
    ...
    public const BUTTON_VIEW = 'components.tree.actions.button-action';

    public const GROUPED_VIEW = 'components.tree.actions.grouped-action';

    public const ICON_BUTTON_VIEW = 'components.tree.actions.icon-button-action';

    public const LINK_VIEW = 'components.tree.actions.link-action';
